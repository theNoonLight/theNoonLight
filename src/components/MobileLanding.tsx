...
export default function MobileLanding() {
  ...
  useEffect(() => {
    // If user is already logged in, stay on home page to show navigation
    ...
    <div className="min-h-screen relative">
      ...
      <div className="absolute top-4 left-4 z-20">
        <button
          ...
          className="bg-transparent text-white py-2 px-4 rounded-lg text-sm font-medium hover:bg-white/10 transition-all duration-200 border border-white/30"
          style={{ 
      ...
      <div className="min-h-screen flex items-center justify-center relative z-10 px-4">
        ...
        {/* Google Sign In Button or Navigation */}
        {!session ? (
          <button
